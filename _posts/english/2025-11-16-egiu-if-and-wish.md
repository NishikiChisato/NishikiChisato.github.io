---
layout: post
title: "[EGIU] if and wish"
date: 2025-11-16 09:06 +0800
categories:
- English
- EGIU
tags:
...
graph LR
	subgraph Base
		ifido[if I do..., I will]
		ifidid[if I did..., I would]
	end
	
	subgraph Derived
		ifp[if + past]
		ifik[if I knew]
		ifihk[If I had known]
		iwik[I wish I knew]
		iwihk[I wish I had known]
	end

Base -- Derived --> ifp
ifido -- Past --> ifidid
ifp -- Specialized --> ifik
ifp <-- Equivalence --> iwik
ifik -- Past --> ifihk
iwik -- Past --> iwihk
```
